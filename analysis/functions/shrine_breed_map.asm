...
; 47 instructions traced
  ...
  0x0800133E: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  0x08001342: cmp        r0, #0                        
  ...
  0x08001350: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  0x08001354: cmp        r0, #0                        
  ...
  0x0800138A: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  0x0800138E: cmp        r0, #1                        
