...
; 330 instructions traced
  ...
  0x0800DB12: b          #0x800dd04                    
  0x0800DB20: b          #0x800dd04                    
  0x0800DB24: movs       r1, #0x17                     
  0x0800DB26: movs       r2, #0                        
  0x0800DB28: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  ...
  0x0800DB4E: lsrs       r0, r0, #0x10                 
  0x0800DB50: cmp        r0, #9                        
  0x0800DB52: bhi        #0x800db56                    
  0x0800DB54: b          #0x800dcb6                    
  0x0800DB56: b          #0x800dd04                    
  0x0800DB6C: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  0x0800DB70: lsls       r0, r0, #0x10                 
  0x0800DB72: lsrs       r0, r0, #0x10                 
  0x0800DB74: subs       r0, r4, r0                    
  0x0800DB76: lsls       r0, r0, #0x10                 
  0x0800DB78: lsrs       r0, r0, #0x10                 
  0x0800DB7A: cmp        r0, #0x13                     
  0x0800DB7C: bhi        #0x800db82                    
  0x0800DB7E: movs       r2, #0                        
  0x0800DB80: str        r2, [sp, #0xc]                
  0x0800DB82: adds       r0, r5, #0                    
  0x0800DB84: movs       r1, #0x67                     
  0x0800DB86: movs       r2, #5                        
  0x0800DB88: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  0x0800DB8C: cmp        r0, #1                        
  0x0800DB8E: beq        #0x800db92                    
  0x0800DB90: b          #0x800dcb6                    
  0x0800DB92: b          #0x800dd04                    
