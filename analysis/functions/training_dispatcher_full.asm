...
; 81 instructions traced
  ...
  0x08001FE6: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  ...
  0x08002010: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  0x08002014: cmp        r0, #0                        
  0x08002016: bne        #0x800208e                    
  0x08002018: adds       r0, r5, #0                    
  0x0800201A: movs       r1, #0xc1                     
  0x0800201C: movs       r2, #0                        
  0x0800201E: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  ...
  0x08002042: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  0x08002046: cmp        r0, #1                        
  0x08002048: bne        #0x800208e                    
  0x0800204A: adds       r0, r5, #0                    
  0x0800204C: movs       r1, #0xc1                     
  0x0800204E: movs       r2, #2                        
  0x08002050: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  ...
  0x0800206E: bl         #0x80035d0                      ; -> field_write(base, field_idx, value, arr_idx)
  0x08002072: b          #0x800208e                    
  0x08002074: adds       r0, r5, #0                    
  0x08002076: movs       r1, #0xb3                     
  0x08002078: movs       r2, #0x19                     
  0x0800207A: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  0x0800207E: cmp        r0, #2                        
  ...
  0x0800208A: bl         #0x80035d0                      ; -> field_write(base, field_idx, value, arr_idx)
  0x0800208E: adds       r0, r5, #0                    
  0x08002090: movs       r1, #0xb3                     
  0x08002092: movs       r2, #0x19                     
  0x08002094: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
