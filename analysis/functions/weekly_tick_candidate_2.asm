; Function at 0x0801FE00
; 198 instructions traced
  ...
  0x0801FED0: bl         #0x80035e4                      ; -> field_modify(base, field_idx, delta, arr_idx) | -> field_49 (offset 0x00BC)
  0x0801FED4: adds       r0, r5, #0                    
  0x0801FED6: movs       r1, #0x18                     
  0x0801FED8: movs       r2, #0                        
  0x0801FEDA: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> field_24 (offset 0x0098)
  0x0801FEDE: cmp        r0, #1                        
  ...
  0x0801FEF0: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> stat999_0x9E (offset 0x009E)
  0x0801FEF4: cmp        r0, #0                        
  0x0801FEF6: bne        #0x801ff2e                    
  0x0801FEF8: adds       r0, r5, #0                    
  0x0801FEFA: movs       r1, #0x19                     
  0x0801FEFC: movs       r2, #0                        
  0x0801FEFE: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> stat999_0x9A (offset 0x009A)
  0x0801FF02: cmp        r0, #0                        
  0x0801FF04: bne        #0x801ff2e                    
  0x0801FF06: adds       r0, r5, #0                    
  0x0801FF08: movs       r1, #0x33                     
  0x0801FF0A: movs       r2, #3                        
  0x0801FF0C: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> field_51 (offset None)
  0x0801FF10: adds       r0, r5, #0                    
  0x0801FF12: movs       r1, #0x33                     
  0x0801FF14: movs       r2, #3                        
  0x0801FF16: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> field_51 (offset None)
  ...
  0x0801FFA8: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> pct_0xA4 (offset 0x00A4)
