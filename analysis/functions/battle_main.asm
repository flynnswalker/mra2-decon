...
; 410 instructions traced
  ...
  0x080433B0: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> field_47 (offset 0x00B4)
  0x080433B4: adds       r4, r0, #0                    
  0x080433B6: mov        r0, r8                        
  0x080433B8: movs       r1, #0x2f                     
  0x080433BA: movs       r2, #0                        
  0x080433BC: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> field_47 (offset 0x00B4)
  ...
  0x08043418: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> field_50 (offset 0x00BD)
  0x0804341C: adds       r4, r0, #0                    
  0x0804341E: mov        r0, r8                        
  0x08043420: movs       r1, #0x32                     
  0x08043422: movs       r2, #0                        
  0x08043424: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> field_50 (offset 0x00BD)
  ...
  0x08043480: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> stat_pow (offset 0x0068)
  0x08043484: adds       r4, r0, #0                    
  0x08043486: mov        r0, r8                        
  0x08043488: movs       r1, #0                        
  0x0804348A: movs       r2, #0                        
  0x0804348C: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> stat_pow (offset 0x0068)
  ...
  0x080434A0: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> stat_int (offset 0x006A)
  0x080434A4: adds       r4, r0, #0                    
  0x080434A6: mov        r0, r8                        
  0x080434A8: movs       r1, #1                        
  0x080434AA: movs       r2, #0                        
  0x080434AC: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> stat_int (offset 0x006A)
  ...
  0x080434C0: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> stat_ski (offset 0x006C)
  0x080434C4: adds       r4, r0, #0                    
  0x080434C6: mov        r0, r8                        
  0x080434C8: movs       r1, #2                        
  0x080434CA: movs       r2, #0                        
  0x080434CC: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> stat_ski (offset 0x006C)
  ...
  0x080434E0: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> stat_spd (offset 0x006E)
  0x080434E4: adds       r4, r0, #0                    
  0x080434E6: mov        r0, r8                        
  0x080434E8: movs       r1, #3                        
  0x080434EA: movs       r2, #0                        
  0x080434EC: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> stat_spd (offset 0x006E)
  ...
  0x08043500: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> stat_def (offset 0x0070)
  0x08043504: adds       r4, r0, #0                    
  0x08043506: mov        r0, r8                        
  0x08043508: movs       r1, #4                        
  0x0804350A: movs       r2, #0                        
  0x0804350C: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> stat_def (offset 0x0070)
  ...
  0x08043520: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> stat_lif (offset 0x0072)
  0x08043524: adds       r4, r0, #0                    
  0x08043526: mov        r0, r8                        
  0x08043528: movs       r1, #5                        
  0x0804352A: movs       r2, #0                        
  0x0804352C: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> stat_lif (offset 0x0072)
  ...
  0x08043566: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> field_12 (offset 0x007A)
  0x0804356A: adds       r4, r0, #0                    
  0x0804356C: adds       r0, r7, #0                    
  0x0804356E: movs       r1, #0xc                      
  0x08043570: movs       r2, #0                        
  0x08043572: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> field_12 (offset 0x007A)
  ...
  0x080435F0: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> field_18 (offset 0x0088)
  0x080435F4: adds       r4, r0, #0                    
  0x080435F6: mov        r0, r8                        
  0x080435F8: movs       r1, #0x12                     
  0x080435FA: movs       r2, #0                        
  0x080435FC: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> field_18 (offset 0x0088)
  ...
  0x0804366C: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> field_18 (offset 0x0088)
  0x08043670: adds       r4, r0, #0                    
  0x08043672: mov        r0, r8                        
  0x08043674: movs       r1, #0x12                     
  0x08043676: movs       r2, #0                        
  0x08043678: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> field_18 (offset 0x0088)
  0x0804367C: cmp        r4, r0                        
  0x0804367E: ble        #0x804368c                    
  0x08043680: mov        r0, r8                        
  0x08043682: movs       r1, #0x12                     
  0x08043684: movs       r2, #0                        
  0x08043686: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> field_18 (offset 0x0088)
  0x0804368A: b          #0x8043696                    
  0x0804368C: adds       r0, r7, #0                    
  0x0804368E: movs       r1, #0x12                     
  0x08043690: movs       r2, #0                        
  0x08043692: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx) | -> field_18 (offset 0x0088)
  0x08043696: cmp        r0, #1                        
