...
; 310 instructions traced
  ...
  0x0801FD0A: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  0x0801FD0E: adds       r5, r0, #0                    
  0x0801FD10: movs       r1, #0x13                     
  0x0801FD12: movs       r2, #0                        
  0x0801FD14: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  ...
  0x0801FD9E: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  0x0801FDA2: cmp        r0, #1                        
