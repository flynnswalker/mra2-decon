...
; 65 instructions traced
  ...
  0x0802021A: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  ...
  0x0802022E: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  0x08020232: cmp        r0, #1                        
  ...
  0x08020248: bl         #0x80035d0                      ; -> field_write(base, field_idx, value, arr_idx)
  0x0802024C: cmp        r4, #2                        
