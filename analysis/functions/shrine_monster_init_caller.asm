...
; 452 instructions traced
  ...
  0x0805FB92: bl         #0x80603d4                      ; -> breed_candidate_dispatcher(parentA, parentB, item, output)
  ...
  0x0805FBAA: bl         #0x8020774                      ; -> monster_init(...)
  0x0805FBAE: ldr        r0, [sp, #0x50]               
  0x0805FBB0: movs       r1, #0x15                     
  0x0805FBB2: movs       r2, #0                        
  0x0805FBB4: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  ...
  0x0805FC00: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  ...
  0x0805FC38: bl         #0x800d2b0                      ; -> learn_technique(monster, tech_id, slot)
  ...
  0x0805FC4A: bl         #0x800d2b0                      ; -> learn_technique(monster, tech_id, slot)
  ...
  0x0805FC86: bl         #0x8029e54                      ; -> apply_breed_data(monster, breed_data_table)
  0x0805FC8A: ldr        r0, [sp, #0x50]               
  0x0805FC8C: ldr        r1, [sp, #0x54]               
  0x0805FC8E: bl         #0x805ff28                      ; -> compatibility_score(parentA, parentB)
  ...
  0x0805FD00: bl         #0x81c79d4                      ; -> __aeabi_idiv(a, b)
  ...
  0x0805FD28: bl         #0x81c79d4                      ; -> __aeabi_idiv(a, b)
  ...
  0x0805FD4E: bl         #0x81c79d4                      ; -> __aeabi_idiv(a, b)
  ...
  0x0805FD74: bl         #0x81c79d4                      ; -> __aeabi_idiv(a, b)
  ...
  0x0805FD9A: bl         #0x81c79d4                      ; -> __aeabi_idiv(a, b)
  ...
  0x0805FDC0: bl         #0x81c79d4                      ; -> __aeabi_idiv(a, b)
  ...
  0x0805FDE2: bl         #0x8060694                      ; -> combining_item_effects(offspring, item_id)
  0x0805FDE6: ldr        r0, [sp, #0x50]               
  0x0805FDE8: ldr        r1, [sp, #0x54]               
  0x0805FDEA: adds       r2, r5, #0                    
  0x0805FDEC: bl         #0x80021b0                      ; -> compute_nature_value(parentA, parentB, offspring)
  ...
  0x0805FE66: bl         #0x8060718                      ; -> copy_technique_ancestry(src_monster, dest_buffer)
  ...
  0x0805FE86: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  ...
  0x0805FEA4: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  ...
  0x0805FEC4: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  ...
  0x0805FEE4: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
