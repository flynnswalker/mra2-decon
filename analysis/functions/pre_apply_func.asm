...
; 27 instructions traced
  ...
  0x080028F0: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  0x080028F4: adds       r4, r0, #0                    
  0x080028F6: adds       r0, r5, #0                    
  0x080028F8: movs       r1, #0x6c                     
  0x080028FA: movs       r2, #0                        
  0x080028FC: bl         #0x80035bc                      ; -> field_read(base, field_idx, arr_idx)
  ...
  0x0800291C: bl         #0x80035d0                      ; -> field_write(base, field_idx, value, arr_idx)
