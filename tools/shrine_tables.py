...
def main():
    ...
    with open(out_path, 'w') as f:
        ...
        f.write('\n')
        f.write('# Breed name lookup (ROM IDs verified via Unicorn emulation against 346 community passwords)\n')
        f.write('BREED_NAMES = {\n')
        f.write('    0: "Pixie", 1: "Golem", 2: "Mew", 3: "Mocchi",\n')
        f.write('    4: "Dragon", 5: "Arrow Head", 6: "Suezo", 7: "Ducken",\n')
        f.write('    8: "Zuum", 9: "Tiger", 10: "Naga", 11: "Octopee",\n')
        f.write('    12: "Mogi", 13: "Psiroller", 14: "Durahan", 15: "Joker",\n')
        f.write('    16: "Momo", 17: "Lesione", 18: "Zan", 19: "Antlan",\n')
        f.write('    20: "Hare", 21: "Suzurin", 22: "Henger", 23: "Raiden",\n')
        f.write('    24: "Gitan", 25: "Gali", 26: "Doodle", 27: "Monol",\n')
        f.write('    28: "Phoenix", 29: "Garu", 30: "Special",\n')
        f.write('}\n')
